...
def evaluate(
    ...
    for time_recording, true_label in recording_labels:
        ...
        predictions, _ = localize_sample_panako(
...
def evaluate_reduced_search_space(
    ...
    for time_recording, true_label in recording_labels:
        ...
        const_ref_subset = get_fraction_of_ref_song(
            ...
            lenght_seconds_ref_song=len(ref_song) / fs_ref,
            length_subset=30,
        )
...
def get_fraction_of_ref_song(
    ref_song_cons_map, fs_ref, indication_time, length_subset, lenght_seconds_ref_song
):
    """
    ...
    if (
        length_subset - (seconds_end - seconds_end)
