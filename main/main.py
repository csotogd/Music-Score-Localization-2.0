...
if __name__ == '__main__':
    ...
    if app_testing:
        ...
        #uncomment above to get ref song divided into subsequent segements
        ...
        if from_mic:
            ...
            while song_segment is not None:
                ...
                constellation_map_segment = sp_pipeline(song_segment, Parameters_IO.fs, denoise=True)
                #TODO include matching algorithm here
                match_time = localization_pipeline(song_constellation_map= constellation_map_ref,
