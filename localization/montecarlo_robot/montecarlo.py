...
def generate_prob_xk_of_prediction_phase(particle, step_size=0.1):
    """
    ...
    Returns
    -------
    A dict where the keys are time points and the values are the probabilities of salecting those keys.
    """
...
if __name__ == '__main__':
    particles = create_initial_set_of_particles(nr_particles=100, length_ref_subset=10)
    print(len(particles))
    print(particles)